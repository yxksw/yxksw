        ...
        <div className="mb-12">
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                <button
                    ...
                    className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm font-medium text-slate-600 bg-slate-100 hover:bg-slate-200 border border-slate-200 transition-all duration-200 hover:scale-105 active:scale-95 shadow-sm hover:shadow"
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-8 h-8 rounded-lg text-sm font-medium transition-all ${currentPage === page
                                                    ? 'bg-gray-400 text-white shadow-md scale-110'
